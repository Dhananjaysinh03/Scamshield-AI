      ...
      <div className="simple-shell min-h-screen w-full overflow-x-clip">
        ...
        <main className="mx-auto w-full max-w-xl min-w-0 px-4 pb-16 pt-6 sm:px-6 sm:pt-8">
          ...
          <p className="mt-2 text-base leading-relaxed text-[var(--ink-muted)]">
            ...
            <strong className="font-semibold text-[var(--ink)]">stop</strong> —
            before you share OTP, pay money, open a file, or share your screen.
          </p>
          ...
          <section className="mt-6">
            ...
            <p className="mt-0.5 text-sm text-[var(--ink-muted)]">
              One tap — we’ll check it for you.
            </p>
            <div className="chip-rail mt-3 -mx-1 px-1">
              {EMAIL_DEMOS.map((d) => (
                <button
                  key={d.id}
                  type="button"
                  ...
                  disabled={busy}
                  className={`min-h-[4.25rem] w-[10.5rem] shrink-0 rounded-2xl border px-3.5 py-2.5 text-left transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand)] disabled:opacity-50 ${
                    demoId === d.id
                      ? d.tone === "safe"
            ...
            {!busy && !result ? (
              <div className="rounded-2xl border border-dashed border-[var(--line)] bg-[var(--card)] px-5 py-10 text-center">
                ...
                <p className="mt-2 text-sm text-[var(--ink-muted)]">
                  Tap <strong className="text-[var(--ink)]">Fake bank OTP</strong>{" "}
                  to try an example.
                </p>
              </div>
            ) : null}
                ...
                {hasHardStop ? (
                  <div className="hard-stop-card" role="alert">
                    ...
                    <p className="mt-2 text-base leading-relaxed opacity-90">
                      Open your real bank / app yourself, or call a number you
                      already know — not a link or number from this email.
                    </p>
                  ...
                  <div className="all-clear-card" role="status">
                    ...
                    <p className="mt-2 text-base leading-relaxed opacity-90">
                      Still be careful with unexpected links. When unsure, ask
                      someone you trust.
                    </p>
                  </div>
                )}
